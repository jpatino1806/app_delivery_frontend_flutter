import 'package:delivery_flutter/src/pages/client/address/map/client_address_map_controller.dart';
   ...
   Widget _buttonSelect(){
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Text('SELECCIONAR ESTE PUNTO',style: TextStyle(fontSize: 18), 
        )),
    );
  }
