...
import 'package:delivery_flutter/src/models/address.dart';
...
import 'package:delivery_flutter/src/provider/address_provider.dart';
...
class ClientAddressCreateController {
  ...
  void createAddress() async{
    ...
    double lat = (refPoint!['lat'] ?? 0).toDouble();
    double lng = (refPoint!['lng'] ?? 0).toDouble();
